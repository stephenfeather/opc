...
var PROJECTS_DIR = path.join(HOME, ".claude", "projects");
var WATERMARK = path.join(HOME, ".claude", "hooks", "scrub-watermark");
var WORKER = path.join(HOME, ".claude", "hooks", "dist", "scrub-transcript.mjs");
