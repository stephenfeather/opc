...
describe('Topological Sort', () => {
    ...
    it('should throw CircularDependencyError for cycle in graph', () => {
        ...
        expect(() => topologicalSort('skill-a', rules)).toThrow(CircularDependencyError);
    });
    it('should include both suggest and require dependencies in order', () => {
        ...
        expect(result.indexOf('suggested-dep')).toBeLessThan(result.indexOf('main-skill'));
        expect(result.indexOf('required-dep')).toBeLessThan(result.indexOf('main-skill'));
    });
