...
describe('Jury Handler', () => {
    ...
    it('should collect votes from jurors', () => {
        ...
        state.votes.push({ agent_id: 'juror1', vote: true }, { agent_id: 'juror2', vote: true }, { agent_id: 'juror3', vote: false });
...
describe('Debate Handler', () => {
    ...
    it('should track debate rounds', () => {
        ...
        state.positions.push({ side: 'pro', agent_id: 'pro-agent', argument: 'Pro argument for round 1' }, { side: 'con', agent_id: 'con-agent', argument: 'Con argument for round 1' });
        state.round = 2;
