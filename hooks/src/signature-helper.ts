...
// makes up to 10 daemon calls (5 call names x search+extract), each capped
// at 3s — 30s worst case. The shared deadline keeps the sum bounded, with
// headroom for node startup and stdout.
