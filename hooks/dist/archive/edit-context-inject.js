 ...
 *
 * Injects file symbols from index before Claude edits a file.
 * Helps Claude understand what's already in the file without reading it.
 */
import { readFileSync, existsSync } from 'fs';
import { basename } from 'path';
const SYMBOL_INDEX_FILE = '/tmp/claude-symbol-index/symbols.json';
...
async function main() {
    ...
    // Get symbols in this file from index
