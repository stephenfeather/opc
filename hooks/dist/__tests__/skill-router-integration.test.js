...
import { resolvePrerequisites, resolveCoActivation, getLoadingMode, buildEnhancedLookupResult, } from '../skill-router.js';
describe('Integration: Full Flow', () => {
    ...
    describe('Prerequisite Resolution Flow', () => {
        ...
        it('should include transitive dependencies in load order', () => {
            ...
            expect(result.loadOrder.indexOf('lean4')).toBeLessThan(result.loadOrder.indexOf('lean4-functors'));
        });
    });
