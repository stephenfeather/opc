...
function main() {
  ...
  const output = {
    hookSpecificOutput: {
      ...
      permissionDecisionReason: `Refusing to read ${hit.description} (${filePath}). Reading credential files writes their contents verbatim into the Claude Code session transcript (~/.claude/projects/.../<session>.jsonl). If you need a specific value, paste a redacted excerpt manually, or use \`grep <KEY> ${filePath}\` from Bash to extract just one line.`
    }
  };
